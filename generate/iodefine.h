...
#define	DRW2D		(*(volatile struct st_drw2d   __evenaccess *)0xE3000)
...
#define	GLCDC		(*(volatile struct st_glcdc   __evenaccess *)0xE0000)
...
#define	RSPI1		(*(volatile struct st_rspi    __evenaccess *)0xD0140)
#define	RSPI2		(*(volatile struct st_rspi    __evenaccess *)0xD0300)
...
#define	SCI10		(*(volatile struct st_sci10   __evenaccess *)0xD0040)
#define	SCI11		(*(volatile struct st_sci10   __evenaccess *)0xD0060)
#define	SCI12		(*(volatile struct st_sci12   __evenaccess *)0x8B300)
#define	SDHI		(*(volatile struct st_sdhi    __evenaccess *)0x8AC00)
#define	SDSI		(*(volatile struct st_sdsi    __evenaccess *)0x95000)
...
#define	FLASHCONST	(*(volatile struct st_flashconst __evenaccess *)0xFE7F7D90)
#define	TEMPSCONST	(*(volatile struct st_tempsconst __evenaccess *)0xFE7F7D7C)
